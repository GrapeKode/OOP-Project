...
bool Medicament::isValidString(string _str) { return _str.length() > 0; };
bool Medicament::isValidValabilitate(string _valabilitate) { return _valabilitate.length() > 0; } // Split the string and get the data
